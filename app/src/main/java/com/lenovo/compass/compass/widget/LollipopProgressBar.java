package com.lenovo.compass.compass.widget;
...
import com.lenovo.compass.compass.R;


public class LollipopProgressBar extends View {

    public LollipopProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttributeset(context, attrs, defStyleAttr);
        init(context);
    }

    public LollipopProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initAttributeset(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.LollipopProgressAttr, defStyle, 0);
        arcColor = typedArray.getColor(R.styleable.LollipopProgressAttr_arcColor, Color.BLUE);
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.LollipopProgressAttr_mborderWidth, resources.getDimensionPixelSize(R.dimen.train_border_width));
