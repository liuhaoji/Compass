...
public class PreferencesUtil {
    ...
    public static boolean putString(String key, String value) {
        if (KsyunApplication.getInstance() == null) return false;
        SharedPreferences settings = KsyunApplication.getInstance().getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
    ...
    public static String getString(String key) {
        return getString(KsyunApplication.getInstance(), key, null);
    }
    ...
    public static boolean putInt(String key, int value) {
        return putInt(KsyunApplication.getInstance(), key, value);
    }
    ...
    public static int getInt(String key) {
        return getInt(KsyunApplication.getInstance(), key, -1);
    }
